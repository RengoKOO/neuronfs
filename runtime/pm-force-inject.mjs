...
[문제 1] 시공간 제약 추론
사우디(UTC+3, 시스템 운영 16~24시, 야외 화상 무대 18~24시 개시)와 한국(UTC+9, 심야 야외 러닝 시작 22시 KST, 진행 2시간, 화상은 뛰기 시작+30분부터 종료-10분 전까지만 진행) 간에 행사 내에서 정확히 30분의 실시간 화상이 가능한가? 불가능하다면 한국의 행사 시작 시간을 앞/뒤로 최소 몇 분 변경해야 하는가?

[문제 2] 릴레이 순서 논리
참가자 [A, B, C, D, E]. 
- B는 C보다 먼저 뛰지만 바로 다음은 아님. 
- D는 E 바로 다음. 
- A는 1번 아님. 
- 만약 C=3이면 A=5 (조건부). 
- E는 2번 아님. 
- A와 E는 연달아 뛰지 않음. 
이때 D가 몇 번째 주자인지만 확정 도출하시오.
